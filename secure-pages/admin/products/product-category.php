                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="settings.php?section=add-category&getrole=product">Add Product Category</a>
                            </div>
                    ...
                    categories.forEach(category => {
                        tableBody += `<tr>
                            ...
                            <td>
                                        ...
                                        <a href="settings.php?section=edit-category&getrole=product&id=${category.product_category_id}">
