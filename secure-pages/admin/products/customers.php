                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="settings.php?section=add-user&getrole=customer">Add Customer</a>
                            </div>
...
<tbody>
    ...
    $(document).ready(function () {
        function fetchUsers() {
            $.ajax({
                url: "api/admin/get_users.php?getrole=customer",
                type: "GET",
                dataType: "json",
                success: function (response) {
                    ...
                    if (response.status === "success" && response.data.length > 0) {
                        response.data.forEach(function (user, index) {
                            let profileImage = user.profile_picture ? `<img src="uploads/users/${user.profile_picture}" width="50" height="50" alt="Profile">` : "No Image";
                            tableBody.append(`
                                <tr>
                                  <td>${index + 1}</td>  
